...
import { Eye, EyeOff, ChevronLeft, ChevronRight, User, Mail } from "lucide-react";
      ...
      <main className="container flex items-center justify-center min-h-screen py-8 px-4">
        <div className="flex flex-col lg:flex-row w-full max-w-[980px] bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="lg:w-[486px] p-6 lg:p-0 lg:pl-6 lg:py-6">
            <div className="w-full h-full rounded-3xl overflow-hidden relative min-h-[400px] lg:min-h-[600px] group">
              {/* Image Container */}
                      ...
                      <div className="space-y-6">
                        <div className="bg-black/15 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                          <p className="text-lg leading-relaxed mb-4">
                            "Joining Ceylon Taste was the best decision! The quality of their products and the warmth of their community makes every order feel special."
                          </p>
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-white/80">Food Enthusiast</p>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <Card className="w-full max-w-md border-0 shadow-none bg-transparent">
              <CardHeader className="text-center space-y-4">
                ...
                <CardDescription className="text-[#1E130B] text-start">
                  Create your account to start your royal culinary journey
                </CardDescription>
              </CardHeader>

              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="fullName" className="text-sm font-medium text-[#1E130B]">Full Name</Label>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 px-4 py-3 bg-white/50 backdrop-blur-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200"
                      value={fullName}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="confirmPassword" className="text-sm font-medium text-[#1E130B]">Confirm Password</Label>
                    <div className="relative">
                      <Input
                        id="confirmPassword"
                ...
                <div className="text-sm">
                  <label className="flex items-start gap-2 cursor-pointer">
                    <input 
                      type="checkbox" 
                      className="w-4 h-4 bg-white/50 border-gray-200 rounded mt-1"
                      checked={agreedToTerms}
                      onChange={(e) => setAgreedToTerms(e.target.checked)}
                    />
                    <span className="text-[#1E130B] text-sm leading-relaxed">
                      I agree to the{" "}
                      <Link href="/terms" className="text-[#B37142] hover:text-orange-700 font-medium">
                        Terms of Service
                      </Link>{" "}
                      and{" "}
                      <Link href="/privacy" className="text-[#B37142] hover:text-orange-700 font-medium">
                        Privacy Policy
                      </Link>
                    </span>
                  </label>
              ...
              <CardFooter className="flex flex-col space-y-4">
                ...
                <Button 
                  ...
                  disabled={loading} 
                  className="w-full py-3 bg-[#B37142] text-white font-medium rounded-xl hover:bg-orange-600 focus:ring-1 focus:ring-offset-2 transform hover:scale-105 transition-all duration-200 shadow-lg"
                >
        ...
        <div className="fixed bottom-4 right-4 max-w-sm p-4 bg-white/20 backdrop-blur-lg border border-white/30 rounded-2xl shadow-xl">
          <h4 className="font-semibold mb-1 text-sm text-gray-800">Welcome Bonus!</h4>
          <p className="text-xs text-gray-600">
            Sign up today and get 15% off your first order with Ceylon Taste. Start your culinary journey with us!
          </p>
        </div>
      </main>
    </div>
